<x-layout>
    ...
    <x-slot:title> Photographer </x-slot:title>
                ...
                <div class="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-xl transition duration-300">
                    ...
                    @if($photographer->images->isNotEmpty())
                        <img src="{{ asset('storage/' . $photographer->images->first()->image) }}"
                            alt="{{ $photographer->nama_photographer }}" class="w-full h-56 object-cover">
                    ...
                    <div class="p-5 flex flex-col h-full">
                        ...
                        <p class="mt-2 text-gray-500 text-sm leading-relaxed text-center h-12">
                            {{ Str::limit($photographer->deskripsi, 80) }}
                        </p>
                        ...
                        {{-- Tombol --}}
                        <a href="{{ route('pelanggan.photographer.show', $photographer->slug) }}"
