<x-layout>
    ...
    <x-slot:title> Paket Pernikahan </x-slot:title>
                ...
                <div class="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-xl transition duration-300">
                    ...
                    @if($paketPernikahan->images->isNotEmpty())
                        <img src="{{ asset('storage/' . $paketPernikahan->images->first()->image) }}"
                            alt="{{ $paketPernikahan->nama_paket }}" class="w-full h-56 object-cover">
                    ...
                    <div class="p-5 flex flex-col h-full">
                        ...
                        <p class="mt-2 text-gray-500 text-sm leading-relaxed text-center h-12">
                            {{ Str::limit($paketPernikahan->deskripsi, 80) }}
                        </p>
                        ...
                        {{-- Tombol --}}
                        <a href="{{ route('pelanggan.paket-pernikahan.show', $paketPernikahan->slug) }}"
