<x-layout>
    ...
    <x-slot:title> Perawatan </x-slot:title>
                ...
                <div class="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-xl transition duration-300">
                    ...
                    @if($perawatan->images->isNotEmpty())
                        <img src="{{ asset('storage/' . $perawatan->images->first()->image) }}"
                            alt="{{ $perawatan->nama_perawatan }}" class="w-full h-56 object-cover">
                    ...
                    <div class="p-5 flex flex-col h-full">
                        ...
                        <p class="mt-2 text-gray-500 text-sm leading-relaxed text-center h-12">
                            {{ Str::limit($perawatan->deskripsi, 80) }}
                        </p>
                        ...
                        {{-- Tombol --}}
                        <a href="{{ route('pelanggan.perawatan.show', $perawatan->slug) }}"
