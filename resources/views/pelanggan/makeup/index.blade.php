<x-layout>
    ...
    <x-slot:title> Makeup </x-slot:title>
                ...
                <div class="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-xl transition duration-300">
                    ...
                    @if($makeup->images->isNotEmpty())
                        <img src="{{ asset('storage/' . $makeup->images->first()->image) }}"
                            alt="{{ $makeup->nama_makeup }}" class="w-full h-56 object-cover">
                    ...
                    <div class="p-5 flex flex-col h-full">
                        ...
                        {{-- Tombol --}}
                        <a href="{{ route('pelanggan.makeup.show', $makeup->slug) }}"
