    ...
    <div class="max-w-7xl mx-auto px-6 py-10">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-10">
            ...
            <div>
                ...
                @php
                    $firstImage = $makeup->images->first();
                @endphp
            ...
            <div>
                ...
                <div class="mt-6">
                    ...
                    @if($makeup->status_ketersediaan == 'Tersedia')
                        ...
                        @if($makeup->status_ketersediaan == 'Tersedia')
                                ...
                                'slug' => $makeup->slug
                                                ...
                                                <form action="{{ route('pelanggan.cart.add') }}" method="POST">
                                                    ...
                                                    <input type="hidden" name="jenis_layanan" value="makeup">
                                                    <input type="hidden" name="id_layanan" value="{{ $makeup->id_makeup }}">
