    ...
    >
      <div class="overflow-y-auto py-5 px-3 h-full bg-white dark:bg-gray-800">
        ...
        <ul class="space-y-2">
          ...
          <li>
    <a
        href="{{ route('admin.penyewaan.index') }}"
        ...
        <span class="ml-3">
          ...
          <li>
            ...
            <ul id="dropdown-sales" class="hidden py-2 space-y-2">
              ...
              <li>
                <a
                  href="{{ route('admin.dekorasi.index') }}"
                  class="flex items-center p-2 pl-11 w-full text-base font-medium text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"
                  >Dekorasi</a
                >
              </li>
               <li>
                <a
                  href="{{ route('admin.wedding-organizer.index') }}"
                  class="flex items-center p-2 pl-11 w-full text-base font-medium text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"
                  >Wedding Organizer</a
                >
              </li>
               ...
               <li>
                <a
                  href="{{ route('admin.pakaian.index') }}"
                  class="flex items-center p-2 pl-11 w-full text-base font-medium text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"
                  >Pakaian</a
                >
              </li>
               ...
               <li>
                <a
                  href="{{ route('admin.hiburan.index') }}"
                  class="flex items-center p-2 pl-11 w-full text-base font-medium text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"
                  >Hiburan</a
                >
              </li>
                ...
                <a
                  href="{{ route('admin.paket-pernikahan.index') }}"
                  class="flex items-center p-2 pl-11 w-full text-base font-medium text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"
                  >Paket Pernikahan</a
                >
              </li>
          ...
          <li>
            ...
            <ul id="dropdown-authentication" class="hidden py-2 space-y-2">
              ...
              <li>
                <a
                  href="{{ route('admin.laporan.pembayaran') }}"
                  class="flex items-center p-2 pl-11 w-full text-base font-medium text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"
                  >Pembayaran</a
                >
              </li>
