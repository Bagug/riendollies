    ...
    <section class="bg-gray-50 dark:bg-gray-900 p-3 sm:p-5">
        ...
        <div class="mx-auto max-w-4xl">
            ...
            <div class="bg-white shadow-md rounded-lg">
                ...
                <form action="{{ route('admin.hiburan.store') }}" method="POST" enctype="multipart/form-data"
                    class="p-6 space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="nama_hiburan" value="{{ old('nama_hiburan') }}"
                            class="w-full rounded-lg border px-3 py-2 @error('nama_hiburan') border-red-500 @else border-gray-300 @enderror">
                        @error('nama_hiburan')
                            <p class="mt-1 text-sm text-red-600">
                                {{ $message }}
                            </p>
