    ...
    <section class="bg-gray-50 dark:bg-gray-900 p-3 sm:p-5">
        ...
        <div class="mx-auto max-w-4xl">
            ...
            <div class="bg-white shadow-md rounded-lg">
                ...
                <form action="{{ route('admin.hiburan.update', $hiburan) }}" method="POST"
                        ...
                        <select name="id_kategori" class="w-full rounded-lg border-gray-300 @error('id_kategori') border-red-500 @else border-gray-300 @enderror">
                            ...
                            @foreach ($categories as $category)
                                <option value="{{ $category->id_kategori }}"
                                    {{ old('id_kategori', $hiburan->id_kategori) == $category->id_kategori ? 'selected' : '' }}>
                    ...
                    <div>
                        ...
                        <input type="text" name="nama_hiburan"
                            value="{{ old('nama_hiburan', $hiburan->nama_hiburan) }}"
                    ...
                    <div>
                        ...
                        <input type="number" name="harga" value="{{ old('harga', $hiburan->harga) }}"
                    ...
                    <div>
                        ...
                        <select name="status_ketersediaan" class="w-full rounded-lg border-gray-300">
                            ...
                            <option value="Tersedia"
                                {{ old('status_ketersediaan', $hiburan->status_ketersediaan) == 'Tersedia' ? 'selected' : '' }}>
                                Tersedia
                            </option>

                            <option value="Tidak Tersedia"
                                {{ old('status_ketersediaan', $hiburan->status_ketersediaan) == 'Tidak Tersedia' ? 'selected' : '' }}>
                                Tidak Tersedia
                            </option>
                    ...
                    <div>
                        ...
                        <textarea rows="5" name="deskripsi"
                            class="w-full rounded-lg border-gray-300 @error('deskripsi') border-red-500 @else border-gray-300 @enderror">{{ old('deskripsi', $hiburan->deskripsi) }}</textarea>
