                ...
                <div class="flex justify-between items-center p-4 border-b">
                    ...
                    <div class="flex items-center justify-between p-6 border-b">
                       ...
                       <div class="flex flex-col sm:flex-row gap-3 w-full md:w-auto">
                            ...
                            <a href="{{ route('admin.photographer.create') }}"
                            ...
                            <form action="{{ route('admin.photographer.index') }}" method="GET" class="flex w-full sm:w-auto">

                                <input type="text" name="search" value="{{ request('search') }}"
                                    placeholder="Cari photographer..."
                    ...
                    <table class="w-full text-sm text-left">
                        ...
                        <thead class="bg-gray-100 uppercase">
                            ...
                            <tr>
                                ...
                                <th class="px-6 py-3 text-center">Nama Photographer</th>
                            ...
                            @forelse($photographers as $photographer)
                                <tr class="border-b">
                                    ...
                                    <td class="px-6 py-4 text-center">
                                        {{ $photographers->firstItem() + $loop->index }}
                                    </td>

                                       <td class="text-center">
                                            {{ $photographer->kode_photographer }}
                                        </td>

                                    <td class="px-6 py-4 ">
                                        <div class="flex justify-center">
                                        @if ($photographer->images->isNotEmpty())
                                            <img src="{{ asset('storage/' . $photographer->images->first()->image) }}"
                                                alt="{{ $photographer->nama_photographer }}" onclick="showImage(this.src)"
                                    ...
                                    <td class="px-6 py-4 text-center">
                                        {{ $photographer->nama_photographer }}
                                    </td>

                                    <td class="px-6 py-4 text-center">
                                        {{ $photographer->kategori->nama_kategori }}
                                    </td>

                                    <td class="px-6 py-4 text-center">
                                        Rp {{ number_format($photographer->harga, 0, ',', '.') }}
                                    </td>

                                    <td class="px-6 py-4 text-center">
                                        {{ $photographer->status_ketersediaan }}
                                    </td>

                                    <td class="px-6 py-4 text-center">

                                        <button id="dropdownDefaultButton{{ $photographer->id_photographer }}"
                                            data-dropdown-toggle="dropdown{{ $photographer->id_photographer }}"
                                        ...
                                        <div id="dropdown{{ $photographer->id_photographer }}"
                                            ...
                                            <ul class="py-2 text-sm text-gray-700">
                                                ...
                                                <li>
                                                    ...
                                                    <a href="{{ route('admin.photographer.edit', $photographer) }}"
                                                ...
                                                <li>
                                                    ...
                                                    <form
                                                        action="{{ route('admin.photographer.destroy', $photographer) }}"
                                                        method="POST">
                                                        ...
                                                        <button type="submit"
                                                            onclick="return confirm('Yakin ingin menghapus photographer ini?')"
                            ...
                            @empty
                                ...
                                <tr>
                                    ...
                                    <td colspan="8" class="text-center py-5">
                                        Data photographer belum tersedia.
                                    </td>
