    ...
    <section class="bg-gray-50 dark:bg-gray-900 p-3 sm:p-5">
        ...
        <div class="mx-auto max-w-4xl">
            ...
            <div class="bg-white shadow-md rounded-lg">
                ...
                <form action="{{ route('admin.photographer.store') }}" method="POST" enctype="multipart/form-data"
                    class="p-6 space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="nama_photographer" value="{{ old('nama_photographer') }}"
                            class="w-full rounded-lg border px-3 py-2 @error('nama_photographer') border-red-500 @else border-gray-300 @enderror">
