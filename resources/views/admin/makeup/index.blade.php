                ...
                <div class="flex justify-between items-center p-4 border-b">
                    ...
                    <div class="flex items-center justify-between p-6 border-b">
                       ...
                       <div class="flex flex-col sm:flex-row gap-3 w-full md:w-auto">
                            ...
                            <a href="{{ route('admin.makeup.create') }}"
                            ...
                            <form action="{{ route('admin.makeup.index') }}" method="GET" class="flex w-full sm:w-auto">

                                <input type="text" name="search" value="{{ request('search') }}"
                                    placeholder="Cari Make Up..."
                    ...
                    <table class="w-full text-sm text-left">
                        ...
                        <thead class="bg-gray-100 uppercase">
                            ...
                            <tr>
                                ...
                                <th class="px-6 py-3 text-center">Nama Make Up</th>
                            ...
                            @forelse($makeups as $makeup)
                                <tr class="border-b">
                                    ...
                                    <td class="px-6 py-4 ">
                                        ...
                                        @if ($makeup->images->isNotEmpty())
                                            <img src="{{ asset('storage/' . $makeup->images->first()->image) }}"
                                                alt="{{ $makeup->nama_makeup }}" onclick="showImage(this.src)"
                                    ...
                                    <td class="px-6 py-4 text-center">
                                        {{ $makeup->kategori->nama_kategori }}
                                    </td>

                                    <td class="px-6 py-4 text-center">
                                        Rp {{ number_format($makeup->harga, 0, ',', '.') }}
                                    </td>

                                    <td class="px-6 py-4 text-center">
                                        {{ $makeup->status_ketersediaan }}
                                    </td>

                                    <td class="px-6 py-4 text-center">

                                        <button id="dropdownDefaultButton{{ $makeup->id_makeup }}"
                                            data-dropdown-toggle="dropdown{{ $makeup->id_makeup }}"
                                        ...
                                        <div id="dropdown{{ $makeup->id_makeup }}"
                                            ...
                                            <ul class="py-2 text-sm text-gray-700">
                                                ...
                                                <li>
                                                    ...
                                                    <a href="{{ route('admin.makeup.edit', $makeup) }}"
                                                ...
                                                <li>
                                                    ...
                                                    <form
                                                        action="{{ route('admin.makeup.destroy', $makeup) }}"
                                                        method="POST">
                                                        ...
                                                        <button type="submit"
                                                            onclick="return confirm('Yakin ingin menghapus Make Up ini?')"
