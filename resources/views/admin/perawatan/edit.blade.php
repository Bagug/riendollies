<x-admin-layout>
    ...
    <section class="bg-gray-50 dark:bg-gray-900 p-3 sm:p-5">
        ...
        <div class="mx-auto max-w-4xl">
            ...
            <div class="bg-white shadow-md rounded-lg">
                ...
                <form action="{{ route('admin.perawatan.update', $perawatan) }}" method="POST"
                    ...
                    <div>
                        ...
                        <select name="id_kategori" class="w-full rounded-lg border-gray-300  @error('id_kategori')
                                border-red-500
                            @else
                                border-gray-300
                            @enderror">
                        ...
                        @enderror">
                            ...
                            @foreach ($categories as $category)
                                <option value="{{ $category->id_kategori }}"
                                    {{ old('id_kategori', $perawatan->id_kategori) == $category->id_kategori ? 'selected' : '' }}>
                    ...
                    <div>
                        ...
                        <input type="text" name="nama_perawatan"
                            value="{{ old('nama_perawatan', $perawatan->nama_perawatan) }}"
                    ...
                    <div>
                        ...
                        <input type="number" name="harga" value="{{ old('harga', $perawatan->harga) }}"
                    ...
                    <div>
                        ...
                        <select name="status_ketersediaan" class="w-full rounded-lg border-gray-300">
                            ...
                            <option value="Tersedia"
                                {{ old('status_ketersediaan', $perawatan->status_ketersediaan) == 'Tersedia' ? 'selected' : '' }}>
                                Tersedia
                            </option>

                            <option value="Tidak Tersedia"
                                {{ old('status_ketersediaan', $perawatan->status_ketersediaan) == 'Tidak Tersedia' ? 'selected' : '' }}>
                                Tidak Tersedia
                            </option>
                    ...
                    <div>
                        ...
                        <textarea rows="5" name="deskripsi"
                            class="w-full rounded-lg border-gray-300 @error('deskripsi') border-red-500 @else border-gray-300 @enderror">{{ old('deskripsi', $perawatan->deskripsi) }}</textarea>
    ...
    <script>
        ...
        function hapusFoto(id) {
            ...
            fetch(`/admin/perawatan/image/${id}`, {
                    method: 'DELETE',
                    headers: {
