    ...
    <section class="bg-gray-50 dark:bg-gray-900 p-3 sm:p-5">
        ...
        <div class="mx-auto max-w-4xl">
            ...
            <div class="bg-white shadow-md rounded-lg">
                ...
                <form action="{{ route('admin.pakaian.update', $pakaian) }}" method="POST"
                    ...
                    <div>
                        ...
                        <select name="id_kategori" class="w-full rounded-lg border-gray-300 @error('id_kategori') border-red-500 @else border-gray-300 @enderror">

                            <option value="">-- Pilih Kategori --</option>

                            @foreach ($categories as $category)
                                <option value="{{ $category->id_kategori }}"
                                    {{ old('id_kategori', $pakaian->id_kategori) == $category->id_kategori ? 'selected' : '' }}>
                    ...
                    <div>
                        ...
                        <input type="text" name="nama_pakaian"
                            value="{{ old('nama_pakaian', $pakaian->nama_pakaian) }}"
                    ...
                    <div>
                        ...
                        <select name="ukuran"
                            class="w-full rounded-lg border-gray-300 @error('ukuran')
                                border-red-500
                            @else
                                border-gray-300
                            @enderror">
>
                    ...
                    <div>
                        ...
                        <input type="number" name="jumlah_item"
                            value="{{ old('jumlah_item', $pakaian->jumlah_item) }}" min="1"
                            class="w-full rounded-lg border-gray-300 
                            @error('jumlah_item')
                                border-red-500
                            @else
                    ...
                    <div>
                        ...
                        <input type="number" name="harga" value="{{ old('harga', $pakaian->harga) }}"
                    ...
                    <div>
                        ...
                        <select name="status_ketersediaan" class="w-full rounded-lg border-gray-300">
                            ...
                            <option value="Tersedia"
                                {{ old('status_ketersediaan', $pakaian->status_ketersediaan) == 'Tersedia' ? 'selected' : '' }}>
                                Tersedia
                            </option>

                            <option value="Tidak Tersedia"
                                {{ old('status_ketersediaan', $pakaian->status_ketersediaan) == 'Tidak Tersedia' ? 'selected' : '' }}>
                                Tidak Tersedia
                            </option>
                    ...
                    <div>
                        ...
                        <textarea rows="5" name="deskripsi"
                            class="w-full rounded-lg border-gray-300 @error('deskripsi') border-red-500 @else border-gray-300 @enderror">{{ old('deskripsi', $pakaian->deskripsi) }}</textarea>
