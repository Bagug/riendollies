                ...
                <form action="{{ route('admin.pakaian.store') }}" method="POST" enctype="multipart/form-data"
                    ...
                    <div>
                        ...
                        <select name="id_kategori"
                            class="w-full rounded-lg border px-3 py-2 @error('id_kategori') border-red-500 @else border-gray-300 @enderror">
                    ...
                    <div>
                        ...
                        <input type="text" name="nama_pakaian" value="{{ old('nama_pakaian') }}"
                            class="w-full rounded-lg border px-3 py-2 @error('nama_pakaian') border-red-500 @else border-gray-300 @enderror">
                        @error('nama_pakaian')
                            <p class="mt-1 text-sm text-red-600">
                                {{ $message }}
                            </p>
                    ...
                    <div>
                        ...
                        <select name="ukuran"
                            class="w-full rounded-lg border-gray-300 @error('ukuran') border-red-500 @else border-gray-300 @enderror">

                            <option value="">-- Pilih Ukuran --</option>

                            @foreach (['S', 'M', 'L', 'XL', 'XXL', 'All Size'] as $ukuran)
                                <option value="{{ $ukuran }}" {{ old('ukuran') == $ukuran ? 'selected' : '' }}>
                    ...
                    <div>
                        ...
                        <input type="number" name="jumlah_item" value="{{ old('jumlah_item') }}" min="1"
                            class="w-full rounded-lg border-gray-300 @error('jumlah_item') border-red-500 @else border-gray-300 @enderror">
                    ...
                    <div>
                        ...
                        <input type="number" name="harga" value="{{ old('harga') }}"
                            class="w-full rounded-lg border px-3 py-2 @error('harga') border-red-500 @else border-gray-300 @enderror">
                    ...
                    <div>
                        ...
                        <select name="status_ketersediaan"
                            class="w-full rounded-lg border px-3 py-2 @error('status_ketersediaan') border-red-500 @else border-gray-300 @enderror">
                    ...
                    <div>
                        ...
                        <textarea rows="5" name="deskripsi"
                            class="w-full rounded-lg border px-3 py-2 @error('deskripsi') border-red-500 @else border-gray-300 @enderror">{{ old('deskripsi') }}</textarea>
