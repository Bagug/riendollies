                ...
                <div class="flex justify-between items-center p-4 border-b">
                    ...
                    <div class="flex items-center justify-between p-6 border-b">
                        ...
                        <div class="flex flex-col sm:flex-row gap-3 w-full md:w-auto">
                            ...
                            <form action="{{ route('admin.pakaian.index') }}" method="GET" class="flex w-full sm:w-auto">

                                <input type="text" name="search" value="{{ request('search') }}"
                                    placeholder="Cari Pakaian..." class="w-full sm:w-72 rounded-lg border-gray-300">
                    ...
                    <table class="w-full text-sm text-left">
                        ...
                        <thead class="bg-gray-100 uppercase">
                            ...
                            <tr>
                                ...
                                <th class="px-6 py-3 text-center">Nama Pakaian</th>
                            ...
                            @forelse($pakaians as $pakaian)
                                <tr class="border-b">
                                    ...
                                    <td class="px-6 py-4 text-center">
                                        {{ $pakaians->firstItem() + $loop->index }}
                                    </td>

                                    <td class="text-center">
                                        {{ $pakaian->kode_pakaian }}
                                    </td>

                                    <td class="px-6 py-4 ">
                                        <div class="flex justify-center">
                                            @if ($pakaian->images->isNotEmpty())
                                                <img src="{{ asset('storage/' . $pakaian->images->first()->image) }}"
                                                    alt="{{ $pakaian->nama_pakaian }}" onclick="showImage(this.src)"
                                    ...
                                    <td class="px-6 py-4 text-center">
                                        {{ $pakaian->kategori->nama_kategori }}
                                    </td>
                                    ...
                                    <td class="px-6 py-4 text-center">
                                        {{ $pakaian->status_ketersediaan }}
                                    </td>

                                    <td class="px-6 py-4 text-center">

                                        <button id="dropdownDefaultButton{{ $pakaian->id_pakaian }}"
                                            data-dropdown-toggle="dropdown{{ $pakaian->id_pakaian }}"
                                        ...
                                        <div id="dropdown{{ $pakaian->id_pakaian }}"
                                            ...
                                            <ul class="py-2 text-sm text-gray-700">
                                                ...
                                                <li>
                                                    ...
                                                    <a href="{{ route('admin.pakaian.edit', $pakaian) }}"
                                                ...
                                                <li>
                                                    ...
                                                    <form action="{{ route('admin.pakaian.destroy', $pakaian) }}"
                                                        method="POST">
                                                        ...
                                                        <button type="submit"
                                                            onclick="return confirm('Yakin ingin menghapus Pakaian ini?')"
