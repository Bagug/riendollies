                ...
                <div class="flex justify-between items-center p-4 border-b">
                    ...
                    <div class="flex items-center justify-between p-6 border-b">
                        ...
                        <div class="flex flex-col sm:flex-row gap-3 w-full md:w-auto">
                            ...
                            <a href="{{ route('admin.paket-pernikahan.create') }}"
                            ...
                            <form action="{{ route('admin.paket-pernikahan.index') }}" method="GET" class="flex w-full sm:w-auto">
                    ...
                    <table class="w-full text-sm text-left">
                        ...
                        <thead class="bg-gray-100 uppercase">
                            ...
                            <tr>
                                ...
                                <th class="px-6 py-3 text-center">Nama Paket Pernikahan</th>
                        ...
                        <tbody>
                            ...
                            @forelse($paketPernikahans as $paketPernikahan)
                                <tr class="border-b">

                                    <td class="px-6 py-4 text-center">
                                        {{ $paketPernikahans->firstItem() + $loop->index }}
                                    </td>

                                    <td class="px-6 py-4 text-center">
                                        {{ $paketPernikahan->kode_paket }}
                                    </td>

                                    <td class="px-6 py-4">
                                        <div class="flex justify-center">
                                            @if ($paketPernikahan->images->isNotEmpty())
                                                <img src="{{ asset('storage/' . $paketPernikahan->images->first()->image) }}"
                                                    alt="{{ $paketPernikahan->nama_paket }}" onclick="showImage(this.src)"
                                                    class="w-20 h-20 rounded-lg object-cover border cursor-pointer transition duration-300 hover:scale-105 hover:shadow-lg">
                                            @else
                                    ...
                                    <td class="px-6 py-4 text-center">
                                        {{ $paketPernikahan->kategori->nama_kategori }}
                                    </td>
                                    ...
                                    <td class="px-6 py-4 text-center">
                                        {{ $paketPernikahan->status_ketersediaan }}
                                    </td>

                                    <td class="px-6 py-4 text-center">

                                        <button id="dropdownDefaultButton{{ $paketPernikahan->id_paket }}"
                                            data-dropdown-toggle="dropdown{{ $paketPernikahan->id_paket }}"
                                        ...
                                        <div id="dropdown{{ $paketPernikahan->id_paket }}"
                                            ...
                                            <ul class="py-2 text-sm text-gray-700">
                                                ...
                                                <li>
                                                    ...
                                                    <a href="{{ route('admin.paket-pernikahan.edit', $paketPernikahan) }}"
                                                ...
                                                <li>
                                                    ...
                                                    <form
                                                        action="{{ route('admin.paket-pernikahan.destroy', $paketPernikahan) }}"
                                                        method="POST">
                                                        ...
                                                        <button type="submit"
                                                            onclick="return confirm('Yakin ingin menghapus Paket Pernikahan ini?')"
                            ...
                            @empty
                                ...
                                <tr>
                                    ...
                                    <td colspan="8" class="text-center py-5">
                                        Data Paket Pernikahan belum tersedia.
                                    </td>
