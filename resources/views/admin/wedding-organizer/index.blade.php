                ...
                <div class="flex justify-between items-center p-4 border-b">
                    ...
                    <div class="flex items-center justify-between p-6 border-b">
                        ...
                        <div class="flex flex-col sm:flex-row gap-3 w-full md:w-auto">
                            ...
                            <a href="{{ route('admin.wedding-organizer.create') }}"
                            ...
                            <form action="{{ route('admin.wedding-organizer.index') }}" method="GET" class="flex w-full sm:w-auto">
                    ...
                    <table class="w-full text-sm text-left">
                        ...
                        <thead class="bg-gray-100 uppercase">
                            ...
                            <tr>
                                ...
                                <th class="px-6 py-3 text-center">Nama Wedding Organizer</th>
                        ...
                        <tbody>
                            ...
                            @forelse($weddingOrganizers as $weddingOrganizer)
                                <tr class="border-b">

                                    <td class="px-6 py-4 text-center">
                                        {{ $weddingOrganizers->firstItem() + $loop->index }}
                                    </td>

                                    <td class="px-6 py-4 text-center">
                                        {{ $weddingOrganizer->kode_wo }}
                                    </td>
                                        ...
                                        <div class="flex justify-center">
                                            @if ($weddingOrganizer->images->isNotEmpty())
                                                <img src="{{ asset('storage/' . $weddingOrganizer->images->first()->image) }}"
                                                    alt="{{ $weddingOrganizer->nama_wo }}" onclick="showImage(this.src)"
                                    ...
                                    <td class="px-6 py-4 text-center">
                                        {{ $weddingOrganizer->kategori->nama_kategori }}
                                    </td>
                                    ...
                                    <td class="px-6 py-4 text-center">
                                        {{ $weddingOrganizer->status_ketersediaan }}
                                    </td>

                                    <td class="px-6 py-4 text-center">

                                        <button id="dropdownDefaultButton{{ $weddingOrganizer->id_wo }}"
                                            data-dropdown-toggle="dropdown{{ $weddingOrganizer->id_wo }}"
                                        ...
                                        <div id="dropdown{{ $weddingOrganizer->id_wo }}"
                                            ...
                                            <ul class="py-2 text-sm text-gray-700">
                                                ...
                                                <li>
                                                    ...
                                                    <a href="{{ route('admin.wedding-organizer.edit', $weddingOrganizer) }}"
                                                ...
                                                <li>
                                                    ...
                                                    <form
                                                        action="{{ route('admin.wedding-organizer.destroy', $weddingOrganizer) }}"
                                                        method="POST">
                                                        ...
                                                        <button type="submit"
                                                            onclick="return confirm('Yakin ingin menghapus Wedding Organizer ini?')"
                            ...
                            @empty
                                ...
                                <tr>
                                    ...
                                    <td colspan="8" class="text-center py-5">
                                        Data Wedding Organizer belum tersedia.
                                    </td>
