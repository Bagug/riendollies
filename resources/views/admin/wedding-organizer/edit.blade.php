<x-admin-layout>
    ...
    <section class="bg-gray-50 dark:bg-gray-900 p-3 sm:p-5">
        ...
        <div class="mx-auto max-w-4xl">
            ...
            <div class="bg-white shadow-md rounded-lg">
                ...
                <form action="{{ route('admin.wedding-organizer.update', $weddingOrganizer) }}" method="POST"
                        ...
                        <select name="id_kategori" class="w-full rounded-lg border px-3 py-2 @error('id_kategori') border-red-500 @else border-gray-300 @enderror">
                            ...
                            @foreach ($categories as $category)
                                <option value="{{ $category->id_kategori }}"
                                    {{ old('id_kategori', $weddingOrganizer->id_kategori) == $category->id_kategori ? 'selected' : '' }}>
                    ...
                    <div>
                        ...
                        <input type="text" name="nama_wo" value="{{ old('nama_wo', $weddingOrganizer->nama_wo) }}"
                    ...
                    <div>
                        ...
                        <input type="number" name="harga" value="{{ old('harga', $weddingOrganizer->harga) }}"
                    ...
                    <div>
                        ...
                        <select name="status_ketersediaan" class="w-full rounded-lg border-gray-300">
                            ...
                            <option value="Tersedia"
                                {{ old('status_ketersediaan', $weddingOrganizer->status_ketersediaan) == 'Tersedia' ? 'selected' : '' }}>
                                Tersedia
                            </option>

                            <option value="Tidak Tersedia"
                                {{ old('status_ketersediaan', $weddingOrganizer->status_ketersediaan) == 'Tidak Tersedia' ? 'selected' : '' }}>
                                Tidak Tersedia
                            </option>
                    ...
                    <div>
                        ...
                        <textarea rows="5" name="deskripsi"
                            class="w-full rounded-lg border-gray-300 @error('deskripsi') border-red-500 @else border-gray-300 @enderror">{{ old('deskripsi', $weddingOrganizer->deskripsi) }}</textarea>
    ...
    <script>
        ...
        function hapusFoto(id) {
            ...
            fetch(`/admin/wedding-organizer/image/${id}`, {
                    method: 'DELETE',
                    headers: {
