    ...
    <section class="bg-gray-50 dark:bg-gray-900 p-3 sm:p-5">
        ...
        <div class="mx-auto max-w-4xl">
            ...
            <div class="bg-white shadow-md rounded-lg">
                ...
                <form action="{{ route('admin.wedding-organizer.store') }}" method="POST" enctype="multipart/form-data"
                    class="p-6 space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="nama_wo" value="{{ old('nama_wo') }}"
                            class="w-full rounded-lg border px-3 py-2 @error('nama_wo') border-red-500 @else border-gray-300 @enderror">
                        @error('nama_wo')
                            <p class="mt-1 text-sm text-red-600">
                                {{ $message }}
                            </p>
