    ...
    <section class="bg-gray-50 dark:bg-gray-900 p-3 sm:p-5">
        ...
        <div class="mx-auto max-w-4xl">
            ...
            <div class="bg-white shadow-md rounded-lg">
                ...
                <form action="{{ route('admin.dekorasi.update', $dekorasi) }}" method="POST" enctype="multipart/form-data"
                    class="p-6 space-y-6">
                        ...
                        <select name="id_kategori" class="w-full rounded-lg border px-3 py-2 @error('id_kategori') border-red-500 @else border-gray-300 @enderror">
                            ...
                            @foreach ($categories as $category)
                                <option value="{{ $category->id_kategori }}"
                                    {{ old('id_kategori', $dekorasi->id_kategori) == $category->id_kategori ? 'selected' : '' }}>
                    ...
                    <div>
                        ...
                        <input type="text" name="nama_dekorasi"
                            value="{{ old('nama_dekorasi', $dekorasi->nama_dekorasi) }}"
                    ...
                    <div>
                        ...
                        <input type="number" name="harga" value="{{ old('harga', $dekorasi->harga) }}"
                    ...
                    <div>
                        ...
                        <select name="status_ketersediaan" class="w-full rounded-lg border-gray-300">
                            ...
                            <option value="Tersedia"
                                {{ old('status_ketersediaan', $dekorasi->status_ketersediaan) == 'Tersedia' ? 'selected' : '' }}>
                                Tersedia
                            </option>

                            <option value="Tidak Tersedia"
                                {{ old('status_ketersediaan', $dekorasi->status_ketersediaan) == 'Tidak Tersedia' ? 'selected' : '' }}>
                                Tidak Tersedia
                            </option>
                    ...
                    <div>
                        ...
                        <textarea rows="5" name="deskripsi"
                            class="w-full rounded-lg border-gray-300 @error('deskripsi') border-red-500 @else border-gray-300 @enderror">{{ old('deskripsi', $dekorasi->deskripsi) }}</textarea>
